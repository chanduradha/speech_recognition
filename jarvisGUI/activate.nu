...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\IoT Training\Codes\pycharm_projects\protocol_exercises\pythonProject5\virenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\IoT Training\Codes\pycharm_projects\protocol_exercises\pythonProject5\virenv\Scripts\deactivate.nu'
